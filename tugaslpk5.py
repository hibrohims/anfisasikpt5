...
with tabx:
    ...
    with st.expander("Percobaan 1"):
        ...
        rumus1a = Image.open('rumus1.jpg')
        st.image(rumus1a, caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
    ...
    with st.expander("Percobaan 2"):
        ...
        rumus2 = Image.open('rumus1.jpg')
        st.image(rumus2, caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
    ...
    with st.expander("Percobaan 3"): 
        ...
        rumus3a = Image.open('rumus1.jpg')
        st.image(rumus3a, caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
        rumus3b = Image.open('rumus3.jpg')
        st.image(rumus3b, caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
    ...
    with st.expander("Percobaan 4"):
        ...
        rumus4 = Image.open('rumus4.jpg')
        st.image(rumus4, caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
    ...
    with st.expander("Percobaan 5"):
        ...
        rumus5a = Image.open('rumus1.jpg')
        st.image(rumus5a, caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
        rumus5b = Image.open('rumus3.jpg')
        st.image(rumus5b, caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
    ...
    with st.expander("Percobaan 6"):
        ...
        rumus6 = Image.open('rumus6.jpg')
        st.image(rumus6, caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
    ...
    with st.expander("Percobaan 7"):
        ...
        rumus7 = Image.open('rumus7.jpg')
        st.image(rumus7, caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
    ...
    with st.expander("Percobaan 8"):
        ...
        rumus8a = Image.open('rumus8a.jpg')
        st.image(rumus8a,caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
        rumus8b = Image.open('rumus8b.jpg')
        st.image(rumus8b,caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
        rumus8c = Image.open('rumus8c.jpg')
        st.image(rumus8c,caption=None, width=250, use_column_width=None, clamp=False, channels="RGB", output_format="auto")
...
with tab3:
        ...
        with st.expander("Percobaan 1, Hubungan Kerapatan dan Kepekatan Larutan"):
            ...
            if tab_1 == "Kerapatan Air":
                ...
                Tombol = st.button ('Hitung Kerapatan Air')
                if Tombol: 
        ...
        with st.expander("Percobaan 2, Penetapan Kerapatan Curah, Absolut, dan Relatif"):
            ...
            Tombol = st.button ('Hitung Kerapatan Deret Standar')
            if Tombol :
                #Kalkulator Curah
        ...
        with st.expander ("Percobaan 3, Penentuan Kekentalan Metode Laju Alir Ostwald"):
            ...
            Tombol = st.button('Hitung Percobaan 3')
            if Tombol :
                #Kerapatan Aquadest
        ...
        with st.expander ("Percobaan 4, Penentuan Kekentalan Metode Silinder Berputar Brookfield"):
            ...
            Tombol = st.button ('Hitung Percobaan 4')
            if Tombol :
        ...
        with st.expander("Percobaan 5, Penentuan Kekentalan Metode Laju Alir Engler"):
            ...
            Tombol = st.button ('Hitung Percobaan 5')
            if Tombol :
                #Kerapatan Aquadest
        ...
        with st.expander("Percobaan 6, Penetapan Titik Leleh"):
            ...
            Tombol = st.button ('Hitung Percobaan 6')
            if Tombol :
        ...
        with st.expander ("Percobaan 7, Penetapan Koefisien Muai Air dan Alkohol"):
            ...
            Tombol = st.button ('Hitung Percobaan 7')
            if Tombol :
        ...
        with st.expander("Percobaan 8, Penetapan Kuat Tekan"):
            ...
            Tombol = st.button ('Hitung Percobaan 8')
            if Tombol :
